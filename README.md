What was done: The app saved product that user clicks to Mongodb, if user clicks product few times the quantity of this product in DB will increase accordinly. User can see the products he selected in the Cart. The button "show more" show more products to user. 
